...
const testimonials = [
  {
    text: "امان یار خرید ۵۰,۰۰۰ دلاری دامنه من را کاملاً بدون استرس کرد. این فرایند از ابتدا تا انتها روان، حرفه‌ای و امن بود.",
    name: "سارا احمدی",
    title: "سرمایه‌گذار دامنه",
  },
  {
    text: "من از امان یار برای فروش کسب‌وکار آنلاینم استفاده کردم. تیم پشتیبانی آنها فوق‌العاده بود و شفافیت در طول فرایند به من آرامش کامل داد.",
    name: "محمدرضا حسینی",
    title: "صاحب کسب‌وکار",
  },
  {
