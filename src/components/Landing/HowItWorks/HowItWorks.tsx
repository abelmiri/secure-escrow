...
const steps: StepCardProps[] = [
  ...
  },
  {
    ...
    title: "پرداخت خریدار",
    description:
      "خریدار مبلغ را پرداخت می‌کند و وجه به صورت امن در حساب امانی نزد بانک نگهداری می‌شود",
    Icon: DollarSign,
  },
  {
    number: "۰۳",
  ...
  },
  {
    ...
    description:
      "تایید نهایی خریدار از دریافت کالا (یا دیگر شروط معامله) پس از بررسی تطابق آن‌ها با شرایط توافق‌شده انجام می‌شود",
    Icon: Badge,
  },
  {
    number: "۰۵",
    title: "آزادسازی وجه",
    description:
      "مبلغ نگهداری شده در حساب امانی پس از تایید نهایی شرایط، به حساب فروشنده آزاد می‌شود",
    Icon: Badge,
  },
]
