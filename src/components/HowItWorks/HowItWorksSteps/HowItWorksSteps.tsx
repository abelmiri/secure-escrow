...
const steps = [
  ...
  },
  {
    ...
    description:
      "خریدار وجه را به امان یار ارسال می‌کند. ما وجوه را تایید کرده و به صورت امن در یک حساب امانی جداگانه نگه می‌داریم.",
    checklist: [
  ...
  },
  {
    ...
    title: "امان یار وجه را به فروشنده می‌پردازد",
    description:
