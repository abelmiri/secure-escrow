...
export const dealsData: Deal[] = [
  {
    ...
    details: {
      ...
      description: "دامنه پریمیوم techstartup.com با سابقه ۵ ساله و رنک بالا",
      location: "آنلاین",
  ...
  },
  {
    ...
    details: {
      category: "وب‌سایت",
      description: "وب‌سایت تجارت الکترونیک کامل با موجودی انبار و سیستم مدیریت سفارش",
      location: "آنلاین",
      deliveryMethod: "انتقال دسترسی‌ها",
      inspectionPeriod: "۳ روز",
      terms: "تمام دسترسی‌ها و کدهای منبع باید تحویل داده شود و وب‌سایت باید بدون مشکل کار کند",
    },
  },
  {
    id: "TXN-004",
    ...
    details: {
      ...
      description: "ساعت رولکس کلاسیک مدل Datejust، طلای ۱۸ عیار، سال ۲۰۲۰",
      location: "تهران",
  ...
  },
  {
    ...
    details: {
      category: "خدمات",
      description: "مشاوره فنی برای بهینه‌سازی زیرساخت‌های IT شرکت",
      location: "آنلاین و حضوری",
      deliveryMethod: "ارائه گزارش و مشاوره",
      inspectionPeriod: "۱۴ روز",
      terms: "خدمات در سه فاز انجام می‌شود و پس از تایید هر فاز، وجه مربوطه آزاد می‌شود",
    },
  },
]
